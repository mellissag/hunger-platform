...
export interface AppTranslations {
  // Mini App /masters list (pick specialist before booking)
  mastersPickTitle: string;
  mastersPickSubtitle: string;
  ...
  /** «Не знаю к какому специалисту» — консультация вместо выбора специалиста */
  ...
  bookErrorMsg: string;
  // Specialist public profile page + catalog row
  ...
  // Booking step 0 when pre-selected specialist
  ...
  // Step 1 – specialist selection checkboxes
...
const RU: AppTranslations = {
  mastersPickTitle: 'Выберите специалиста',
  mastersPickSubtitle: 'Подберём удобное время в пару шагов',
  mastersLoadError: 'Не удалось загрузить специалистов',
  ...
  homeDesc: 'Любимые специалисты, ваш ритм и расписание — всё в одном жесте.',
  ...
  catSearchPlaceholder: 'Услуга или специалист',
  ...
  detailDuration: 'Длительность', detailPrice: 'Цена', detailMasters: 'Специалист', detailBook: 'Записаться',
  bookEyebrow: 'Бронирование', bookCatH: 'Коллекция', bookCatHi: 'услуг',
  bookStep1: 'Шаг 1 из 3', bookMasterH: 'Выберите', bookMasterHi: 'специалиста', bookNoMasters: 'Нет доступных специалистов',
  bookConsultUnknownTitle: 'Не знаю к какому специалисту',
  bookConsultUnknownSub: 'Обсудим детали и подберём специалиста на созвоне',
  bookOrPickMaster: 'или выберите специалиста',
  bookConsultCallTitleBefore: 'Мы ',
  bookConsultCallHi: 'свяжемся',
  bookConsultCallTitleAfter: ' с вами',
  bookConsultCallSub: 'Наш администратор подберёт для вас специалиста и удобное время. Ожидайте звонка.',
  bookConsultYourRequest: 'Ваша заявка',
  bookConsultTimeNote: 'Специалист и время — уточним при звонке',
  ...
  bookSvcLabel: 'Услуга', bookMasterLabel: 'Специалист', bookDateTimeLabel: 'Дата и время',
  ...
  masterProfileBack: 'Назад', masterProfileBookWithMaster: 'Записаться к специалисту', masterProfileBookService: 'Записаться',
  ...
  bookCheckboxAnyMaster: 'Не важно / любой специалист',
  bookCheckboxAnyMasterHint: 'Назначим свободного специалиста.',
  ...
  bookConfirmMasterLabel: 'Специалист',
  ...
  bookConfirmAnyMasterDisplay: 'Любой свободный специалист',
...
const EN: AppTranslations = {
  mastersPickTitle: 'Choose a specialist',
  mastersPickSubtitle: 'We will find a convenient time in a few steps',
  mastersLoadError: 'Could not load specialists',
  ...
  homeDesc: 'Favourite specialists, your rhythm and schedule — all in one gesture.',
  ...
  catSearchPlaceholder: 'Service or specialist',
  ...
  detailDuration: 'Duration', detailPrice: 'Price', detailMasters: 'Specialist', detailBook: 'Book now',
  bookEyebrow: 'Booking', bookCatH: 'Service', bookCatHi: 'catalog',
  bookStep1: 'Step 1 of 3', bookMasterH: 'Choose', bookMasterHi: 'specialist', bookNoMasters: 'No specialists available',
  ...
  bookSvcLabel: 'Service', bookMasterLabel: 'Specialist', bookDateTimeLabel: 'Date & time',
  ...
  bookCheckboxAnyMaster: 'Any available specialist',
  bookCheckboxAnyMasterHint: 'We will assign an available specialist.',
  ...
  bookConfirmMasterLabel: 'Specialist',
  ...
  bookConfirmAnyMasterDisplay: 'Any available specialist',
...
const UK: AppTranslations = {
  mastersPickTitle: 'Оберіть спеціаліста',
  mastersPickSubtitle: 'Підберемо зручний час за кілька кроків',
  mastersLoadError: 'Не вдалося завантажити спеціалістів',
  ...
  homeDesc: 'Улюблені спеціалісти, ваш ритм і розклад — все в одному жесті.',
  ...
  catSearchPlaceholder: 'Послуга або спеціаліст',
  ...
  detailDuration: 'Тривалість', detailPrice: 'Ціна', detailMasters: 'Спеціаліст', detailBook: 'Записатись',
  bookEyebrow: 'Бронювання', bookCatH: 'Колекція', bookCatHi: 'послуг',
  bookStep1: 'Крок 1 з 3', bookMasterH: 'Оберіть', bookMasterHi: 'спеціаліста', bookNoMasters: 'Немає доступних спеціалістів',
  bookConsultUnknownTitle: 'Не знаю, до якого спеціаліста',
  bookConsultUnknownSub: 'Обговоримо деталі й підберемо спеціаліста під час дзвінка',
  bookOrPickMaster: 'або оберіть спеціаліста',
  bookConsultCallTitleBefore: 'Ми ',
  bookConsultCallHi: 'звʼяжемося',
  bookConsultCallTitleAfter: ' з вами',
  bookConsultCallSub: 'Адміністратор підбере спеціаліста й зручний час. Очікуйте дзвінка.',
  bookConsultYourRequest: 'Ваша заявка',
  bookConsultTimeNote: 'Спеціаліста й час уточнимо під час дзвінка',
  ...
  bookSvcLabel: 'Послуга', bookMasterLabel: 'Спеціаліст', bookDateTimeLabel: 'Дата і час',
  ...
  masterProfileBack: 'Назад', masterProfileBookWithMaster: 'Записатися до спеціаліста', masterProfileBookService: 'Записатися',
  ...
  bookCheckboxAnyMaster: 'Не важливо / будь-який спеціаліст',
  bookCheckboxAnyMasterHint: 'Призначимо вільного спеціаліста.',
  ...
  bookConfirmMasterLabel: 'Спеціаліст',
  bookConfirmDateLabel: 'Дата',
  ...
  bookConfirmAnyMasterDisplay: 'Будь-який вільний спеціаліст',
...
const BG: AppTranslations = {
  mastersPickTitle: 'Изберете специалист',
  mastersPickSubtitle: 'Ще намерим удобно време за няколко стъпки',
  mastersLoadError: 'Неуспешно зареждане на специалистите',
  ...
  homeDesc: 'Любими специалисти, вашият ритъм и разписание — всичко с един жест.',
  ...
  detailDuration: 'Продължителност', detailPrice: 'Цена', detailMasters: 'Специалист', detailBook: 'Запиши се',
  bookEyebrow: 'Резервация', bookCatH: 'Колекция', bookCatHi: 'услуги',
  bookStep1: 'Стъпка 1 от 3', bookMasterH: 'Изберете', bookMasterHi: 'специалист', bookNoMasters: 'Няма достъпни специалисти',
  bookConsultUnknownTitle: 'Не знам към кой специалист',
  bookConsultUnknownSub: 'Ще обсъдим детайлите и ще ви насочим към специалист при обаждане',
  bookOrPickMaster: 'или изберете специалист',
  bookConsultCallTitleBefore: 'Ще се ',
  bookConsultCallHi: 'свържем',
  bookConsultCallTitleAfter: ' с вас',
  bookConsultCallSub: 'Администраторът ще ви насочи към специалист и удобно време. Очаквайте обаждане.',
  bookConsultYourRequest: 'Вашата заявка',
  bookConsultTimeNote: 'Специалист и час — ще уточним по телефона',
  ...
  bookSvcLabel: 'Услуга', bookMasterLabel: 'Специалист', bookDateTimeLabel: 'Дата и час',
  ...
  masterProfileBack: 'Назад', masterProfileBookWithMaster: 'Запиши се при специалиста', masterProfileBookService: 'Запиши се',
  ...
  bookDurLabel: (m) => m < 60 ? `${m} мин` : m % 60 ? `${Math.floor(m / 60)} ч ${m % 60} мин` : `${m / 60} ч`,
  bookCheckboxAnyMaster: 'Без значение / всеки специалист',
  bookCheckboxAnyMasterHint: 'Ще назначим свободен специалист.',
  ...
  bookConfirmAnyMasterDisplay: 'Всеки свободен специалист',
